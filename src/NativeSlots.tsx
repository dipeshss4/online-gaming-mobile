...
const g = StyleSheet.create({
  ...
  cabinet: { overflow: 'hidden', padding: 16, borderRadius: 18, borderWidth: 2, borderColor: '#c5a75e', backgroundColor: '#242030', gap: 20 },
  ...
  winner: { borderColor: '#efd49b', backgroundColor: '#3a2520' }, payGlow: { position: 'absolute' as const, left: 0, right: 0, top: 0, bottom: 0, backgroundColor: '#efd49b' }, line: { color: '#d9c290', fontSize: 11, textAlign: 'center', letterSpacing: 1.6 }, chip: { flex: 1, alignItems: 'center', padding: 14, borderRadius: 12, backgroundColor: '#211924' },
});
